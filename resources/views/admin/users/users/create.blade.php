        ...
        <form class="validate form-horizontal"  role="form" method="POST" action="{{ route($model.'.store') }}" enctype = "multipart/form-data">
            ...
            <div class="box-body">
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type = "password" name="password" placeholder="Password" maxlength="30" class="form-control" required>
                    </div>
                </div>
            </div>
            ...
            <div class="box-body">
             ...
             <div class="box-body">
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                       {!! Form::number('max_discount_percent', 0,['class'=>'form-control','placeholder'=>'Value','min'=>0,'max'=>100]) !!}
                    </div>
                </div>
            </div>
